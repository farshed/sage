...
2. Next, you have two choices: Run Sage as a Docker container (the easy way) or natively (the hard way). _Running it with Docker has a performance penalty (Inference is 5-8x slower than running it natively)._
